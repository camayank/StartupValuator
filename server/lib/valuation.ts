...
const INDUSTRY_METRICS = {
  ...
  digital_content: {
    ...
    reinvestmentRate: 0.28,
    operatingMargin: 0.22,
    sustainableGrowth: 0.16,
    customerAcquisitionCost: 0.32,
    churnRate: 0.15,
  },
  digital_payments: {
    base: 14,
  ...
  data_analytics: {
    ...
    operatingMargin: 0.28,
    sustainableGrowth: 0.20,
    dataProcessingVolume: 20000000,
    algorithmAccuracy: 0.95,
  },
  ...
  retail_general: {
    ...
    sustainableGrowth: 0.07,
    inventoryTurnover: 5.0,
    locationEfficiency: 0.75,
  },
  retail_special: {
    base: 7,
    growth: 1.1,
    ...
    sustainableGrowth: 0.09,
    inventoryTurnover: 4.5,
    customerLoyalty: 0.65,
  },
  ...
  biotechnology: {
    ...
    operatingMargin: 0.25,
    sustainableGrowth: 0.18,
    clinicalSuccessRate: 0.12,
    patentProtection: 0.95,
  },
  pharmaceuticals: {
    base: 13,
    growth: 1.5,
  ...
  agriculture: {
    ...
    operatingMargin: 0.12,
    sustainableGrowth: 0.05,
    yieldEfficiency: 0.80,
    weatherRiskIndex: 0.20,
  },
};
